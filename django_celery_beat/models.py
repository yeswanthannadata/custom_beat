...
class PeriodicTasks(models.Model):
    ...
    ident = models.SmallIntegerField(default=1, primary_key=True)
...
class PeriodicTask(models.Model):
    ...
    starts = models.DateTimeField(
        _('starts'), blank=True, null=True,
    )
    customer_id = models.PositiveIntegerField(default=0,)
    created_date =  models.DateTimeField(
	_('created date'), blank=True, null=True,
    )
    created_by = models.PositiveIntegerField(
	_('created by'),  blank=True, null=True, default=0,
    )
    updated_date =  models.DateTimeField(
        _('updated date'), blank=True, null=True,
    )
    updated_by = models.PositiveIntegerField(
        _('updated by'),  blank=True, null=True, default=0,
    )
    current_flag = models.PositiveIntegerField(_('current flag'), default=1,)
    active_flag = models.PositiveIntegerField(_('active flag'), default=1,)
    delete_flag = models.PositiveIntegerField(_('delete flag'), default=0,)
    display_flag = models.PositiveIntegerField(_('display flag'), default=1,)
    enabled = models.BooleanField(
        _('enabled'), default=True,
    )
    report_type = models.CharField(_('report_type'), max_length=100, default='')
