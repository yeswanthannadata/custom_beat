...
class PeriodicTask(models.Model):
	...
	_('created by'),  max_length=200, blank=True, null=True, default=None,
    )
    updated_date =  models.DateTimeField(
        _('updated date'), blank=True, null=True,
    )
    updated_by = models.CharField(
        _('updated by'),  max_length=200, blank=True, null=True, default=None,
    )
    current_flag = models.BooleanField(_('current flag'), default=True,)
    active_flag = models.BooleanField(_('active flag'), default=True,)
    delete_flag = models.BooleanField(_('delete flag'), default=False,)
    display_flag = models.BooleanField(_('display flag'), default=True,)
