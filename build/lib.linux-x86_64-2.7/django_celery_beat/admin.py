...
class PeriodicTaskAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('name', 'regtask', 'task', 'report_type', 'report_id', 'enabled', 'current_flag', 'active_flag', 'delete_flag', 'display_flag'),
        ...
        ('Execution Options', {
            'fields': ('expires', 'starts', 'queue', 'exchange', 'routing_key', 'customer_id', 'created_by', 'created_date', 'updated_by', 'updated_date'),
            'classes': ('extrapretty', 'wide', 'collapse', 'in'),
        }),
    )
